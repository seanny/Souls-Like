...
namespace bTools.ObjectPainter
{
    public class ObjectPainterWindow : EditorWindow
    {
        #region Properties
        // GUI
        private readonly GUIContent parentContent = new GUIContent("Parent", "Painted objects will be parented to this Transform. This setting is not saved !");
        ...
        private void OnGUI()
        {
            ...
            using (new GUILayout.AreaScope(rightRect))
            {
                ...
                using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox))
                {
                    ...
                    parent = EditorGUILayout.ObjectField(parentContent, parent, typeof(Transform), true) as Transform;
